...
archon049-surgery-target-not-dead = { $target } должен быть мертв.
archon049-surgery-target-was-surgery = Над подобным животным уже были эксперименты.
archon049-global-announcement = Здравствуйте. Я слышу ваше дыхание. Не беспокойтесь. Я - лечение.
