...
feedbackpopup-control-ui-footer = Расскажите, что вы думаете!
# Command strings
...
command-description-feedback-add = Добавляет прототип окна обратной связи указанным клиентам и открывает окно, если у клиента ещё нет этого прототипа.
...
cmd-givefeedbackpopup-desc = Выдаёт выбранному игроку окно обратной связи.
...
feedbackpopup-command-error-popup-send-fail = Не удалось отправить окно! Возможно, у указанной сущности отсутствует разум.
