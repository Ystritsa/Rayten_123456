...
uplink-bulldog-desc = Компактный и злобный: содержит популярный дробовик Bulldog.
uplink-estoc-name = Estoc DMR
uplink-estoc-desc = Винтовка стрелка, оснащённая оптикой средней дальности для боя на дистанции.
uplink-grenade-launcher-name = China‑Lake
uplink-grenade-launcher-desc = Старый гранатомёт China‑Lake в комплекте с 5 осколочными боеприпасами.
...
uplink-syndimov-law-name = Плата законов Syndi
uplink-syndimov-law-desc = Подрывной набор законов для тех случаев, когда вы хотите переманить ИИ на свою сторону. Используйте как можно активнее.
