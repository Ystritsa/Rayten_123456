...
ent-ClothingBackpackDuffelSyndicateFilledMedicine = медицинская сумка синдиката
    .desc = Большая сумка, содержащая необходимые медицинские реагенты.
...
ent-ClothingBackpackDuffelSyndicateFilledHushpup = Набор «Тихоня»
    .desc = Содержит дробовик «Тихоня» вместе с коробкой дроби.
