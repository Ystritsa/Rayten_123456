...
ent-JetInjector = струйный инжектор
    .desc = Стерильный инжектор для удобного введения препаратов пациентам.
ent-AdvancedJetInjector = продвинутый струйный инжектор
    .desc = Безупречный, стильный инжектор высокого качества. Позволяет вводить препараты быстрее и обладает немного большей вместимостью.
