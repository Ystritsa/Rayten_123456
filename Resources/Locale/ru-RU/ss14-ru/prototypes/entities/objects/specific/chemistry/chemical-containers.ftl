ent-Jug = кувшин
    .desc = Используется для хранения очень большого количества химикатов или растворов. Пить содержимое настоятельно не рекомендуется.
ent-JugPunctTranex = { ent-Jug }
    .suffix = пунктуразин и транексамовая кислота
    .desc = { ent-Jug.desc }
