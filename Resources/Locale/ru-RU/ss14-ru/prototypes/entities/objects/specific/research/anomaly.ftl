...
ent-AnomalyScannerAdmin = административный сканер аномалий
    .desc = Ручной сканер, предназначенный для сбора информации о различных аномальных объектах. Похоже, у этого есть несколько дополнительных функций.
    .suffix = Админ
