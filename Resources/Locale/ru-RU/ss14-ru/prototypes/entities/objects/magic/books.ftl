...
ent-WizardsGrimoireDebug = { ent-WizardsGrimoire }
    .desc = Тяжёлый том, содержащий сложные арканные формулы для подготовки заклинаний и создания сверхъестественного снаряжения. На внутренней обложке кто-то написал «ТОЛЬКО ДЛЯ ЭКСПЕРИМЕНТОВ».
