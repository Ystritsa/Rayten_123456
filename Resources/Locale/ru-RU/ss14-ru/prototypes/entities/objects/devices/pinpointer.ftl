...
ent-PinpointerMothershipPiece = часть пинпоинтера ядра
    .desc = Часть пинпоинтера ядра. Для его починки требуется четыре таких части.
ent-PinpointerMothershipRepaired = отремонтированный пинпоинтер ядра
    .desc = Портативное устройство слежения, указывающее направление на ядро Материнского корабля. Видало лучшие времена.
