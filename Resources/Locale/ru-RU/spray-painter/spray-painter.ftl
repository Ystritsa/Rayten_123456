# Components
spray-painter-ammo-on-examine = В нём { $charges } зарядов.
...
spray-painter-interact-no-color-pick = Не удалось найти цвет для выбора!
spray-painter-interact-color-picked = Цвет выбран с «{ $id }».
spray-painter-on-examined-painted-message = Похоже, его недавно покрасили.
spray-painter-style-not-available = Невозможно применить выбранный стиль к этому объекту.
spray-painter-verb-toggle-decals = Переключить нанесение декалей
...
spray-painter-style-locker-cmo = Главврач
...
spray-painter-style-locker-evac = Эвакуационный
