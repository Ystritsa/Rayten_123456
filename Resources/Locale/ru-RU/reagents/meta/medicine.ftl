...
reagent-name-dexalin-plus-saline = Дексалин плюс и физиологический раствор
...
reagent-desc-arcryox = Отвратительно голубой криогенный химикат, способный лечить тяжелые раны даже у мертвых. Однако он плохо стабилизирует пациентов.
...
reagent-desc-warfarin = Широко используется как антикоагулянт. Заставляет кровь хуже образовывать сгустки. При передозировке может вызвать внутреннее кровотечение.
